...
export const DIST_CONFIGS = {
  lognormal: {
    ...
    cost: {
      ...
      guidance: 'When this incident occurs, what\'s the typical cost? (P50) In a worst-case scenario — 1 in 20 times — what would it cost? (P95)',
    },
  },
  pert: {
    label: 'PERT',
  ...
  pareto: {
    ...
    frequency: {
      ...
      guidance: 'In a typical year, how many incidents? (P50) In a bad year — 1 in 20? (P95)',
    },
    cost: {
      defaults: { p50: 50000, p95: 500000 },
      fields: [
      ...
      guidance: 'What is the typical incident cost? (P50) A bad scenario — 1 in 20? (P95)',
    },
  },
};
...
export const DEFAULT_SCENARIOS = [
  { name: 'Product Exploit', frequencyMethod: 'odds', frequencyParams: { odds: 3 }, costDistType: 'lognormal', costParams: { p50: 100000, p95: 1000000 } },
  { name: 'Malicious Insider', frequencyMethod: 'odds', frequencyParams: { odds: 10 }, costDistType: 'lognormal', costParams: { p50: 200000, p95: 2000000 } },
  { name: 'DDoS', frequencyMethod: 'odds', frequencyParams: { odds: 2 }, costDistType: 'lognormal', costParams: { p50: 20000, p95: 200000 } },
  { name: 'Supply Chain', frequencyMethod: 'odds', frequencyParams: { odds: 20 }, costDistType: 'lognormal', costParams: { p50: 200000, p95: 2000000 } },
  { name: 'Credential Leak / Theft', frequencyMethod: 'odds', frequencyParams: { odds: 2 }, costDistType: 'lognormal', costParams: { p50: 30000, p95: 300000 } },
  { name: 'Compromised Software Download', frequencyMethod: 'odds', frequencyParams: { odds: 15 }, costDistType: 'lognormal', costParams: { p50: 50000, p95: 500000 } },
  { name: 'Social Engineering', frequencyMethod: 'odds', frequencyParams: { odds: 3 }, costDistType: 'lognormal', costParams: { p50: 25000, p95: 250000 } },
  { name: 'Zero Day Targeting Employee', frequencyMethod: 'odds', frequencyParams: { odds: 50 }, costDistType: 'lognormal', costParams: { p50: 100000, p95: 1000000 } },
  { name: 'Exposed and Exploited Service', frequencyMethod: 'odds', frequencyParams: { odds: 5 }, costDistType: 'lognormal', costParams: { p50: 50000, p95: 500000 } },
  { name: 'Ransomware', frequencyMethod: 'odds', frequencyParams: { odds: 5 }, costDistType: 'lognormal', costParams: { p50: 100000, p95: 1000000 } },
];
